...
<div class="container-fluid">
    ...
    <form id="formulario" class="form-horizontal" enctype="multipart/form-data" onsubmit="return comprobarPonenciad()"  action="index.php?controlador=Ponencia" method="post">

        <!-- Materia -->

        <h2 class="col-md-offset-4 col-lg-offset-3 text-center">Registrar Ponencia</h2>
        ...
        <div class="form-group form-group-md">
            ...
            <div class="col-md-8 col-lg-9">
                <input name="CodigoP" name="CodigoP" type="text" placeholder="Codigo Ponencia" class="form-control <?php if(isset($errores) && in_array("CodigoP", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["CodigoP"])?$_POST["CodigoP"]:''?>" >
        ...
        <div class="col-md-offset-4 col-lg-offset-3 text-center">
            <button type="submit" id="AltaPonencia" name="evento" value="altaPonencia" class="btn btn-orange">
                Alta Ponencia
            </button>
        </div>
