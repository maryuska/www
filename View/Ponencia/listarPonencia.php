                ...
                <div class="row">
                    <form class="form-horizontal" action="index.php?controlador=Tad" method="POST" role="search">
                        ...
                        <div class="col-lg-6 col-md-3 col-xs-2 text-right">
                            <a class="btn btn-orange " href="index.php?controlador=Ponencia&evento=paginaInsertarPonencia">
                                Insertar Ponencia
                            </a>
                        </div>
                    </form>
            ...
            <div class="tab-content">
					...
					<?php echo $row['PaisCP']; ?>                                    
                                ...
                                <div class="margin-bottom5 text-center">
                                    <form name="formBorrarPonencia<?php echo $contador; ?>" id="formBorrarPonencia<?php echo $contador; ?>" class="text-center" action="index.php" method="get">
                                        <input type="hidden" name="controlador" value="Ponencia">
                                        <input type="hidden" name="evento" value="borrarPonencia">
                                        <input type="hidden" name="CodigoP" value="<?php echo $row['CodigoP']; ?>">
                                        <input type="hidden" name="LoginU" value="<?php echo $row['LoginU']; ?>">
                                        <button type="button" class="btn btn-transparent btn-orange" onClick="window.location.href='index.php?controlador=Ponencia&evento=consultarPonencia&CodigoP=<?php echo $row['CodigoP']; ?>'">
                                            Modificar
                                        </button>
