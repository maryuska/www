                ...
                <form id="formulario" class="form-horizontal" enctype="multipart/form-data" onsubmit="return comprobarTad()"  action="index.php?controlador=Tesis" method="post">
                    ...
                    <div class="form-group form-group-md">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <p> <select id="Login" name="Login" type="text" placeholder="Login usuario" class="form-control <?php if(isset($errores) && in_array("LoginU", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["LoginU"])?$_POST["LoginU"]:''?>">
                                    <option>--</option>
                    ...
                    <div class="form-group form-group-md">
                        <label class="col-md-4 col-lg-3 control-label" for="AdjuntoT">Adjunto</label>
                        <div class="col-md-8 col-lg-9">
                            <input id="AdjuntoT" name="AdjuntoT" type="file" class="form-control <?php if(isset($errores) && in_array("AdjuntoT", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["AdjuntoT"])?$_POST["AdjuntoT"]:''?>" >
                        </div>
                    </div>
