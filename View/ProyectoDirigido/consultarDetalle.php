        ...
        <div class="col-md-12">
            <?php foreach ($_SESSION["consultarProyectoDirigido"] as $row)  { ?>
                <form  action="../../Controller/ProyectosDirigidosController.php" method="post" role="form">
                    ...
                    <p align="center ">
                        <button type="button" class="btn btn-orange " onclick="window.location.href='../../Controller/ProyectosDirigidosController.php?evento=listarProyectosDirigidos'">Listar Proyectos Dirigidos</button>
                    </p>
