...
<div class="container-fluid">
    ...
    <form id="formulario" class="form-horizontal" enctype="multipart/form-data" onsubmit="return comprobarCongreso()"  action="index.php?controlador=Congresos" method="post">
        ...
        <div class="form-group form-group-md">
            <label class="col-md-4 col-lg-3 control-label" for="AdjuntoC">Adjunto</label>
            <div class="col-md-8 col-lg-9">
                <input id="AdjuntoC" name="AdjuntoC" type="file" class="form-control <?php if(isset($errores) && in_array("AdjuntoC", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["AdjuntoC"])?$_POST["AdjuntoC"]:''?>" >
            </div>
        </div>
