            ...
            <div class="cotainer">
                ...
                <div class="row">
                    <form class="form-horizontal" action="index.php?controlador=Congresos" method="POST" role="search">
                        ...
                        <div class="col-lg-6 col-md-3 col-xs-2 text-right">
                            <a class="btn btn-orange " href="index.php?controlador=Congresos&evento=paginaInsertarCongresoAdmin">
                                Alta congreso
                            </a>
                        </div>
                    </form>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                        <?php
                        $lista = $_SESSION["listarCongresosAdmin"];
                        $contador   = 1;
                        if (isset($lista)) {
                    ...
                    <div class="tab-pane fade" id="tab2">
                        <?php
                        $lista1 = $_SESSION["listarCongresosMCOAdmin"];
                        $contador1   = 1;
                        if (isset($lista1)) {
                    ...
                    <div class="tab-pane fade " id="tab3">
                        <?php
                        $lista2 = $_SESSION["listarCongresosMCCAdmin"];
                        $contador2   = 1;
                        if (isset($lista2)) {
                    ...
                    <div class="tab-pane fade" id="tab4">
                        <?php
                        $lista3 = $_SESSION["listarCongresosRAdmin"];
                        $contador3   = 1;
                        if (isset($lista3)) {
                    ...
                    <div class="tab-pane fade" id="tab5">
                        <?php
                        $lista4 = $_SESSION["listarCongresosCAdmin"];
                        $contador4   = 1;
                        if (isset($lista4)) {
                    ...
                    <div class="tab-pane fade" id="tab6">
                        <?php
                        $lista5 = $_SESSION["listarCongresosPCOAdmin"];
                        $contador5   = 1;
                        if (isset($lista5)) {
                    ...
                    <div class="tab-pane fade " id="tab7">
                        <?php
                        $lista6 = $_SESSION["listarCongresosPCCAdmin"];
                        $contador6   = 1;
                        if (isset($lista6)) {
