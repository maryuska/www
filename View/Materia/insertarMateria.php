...
<div class="container-fluid">
    ...
    <form id="formulario" class="form-horizontal" enctype="multipart/form-data" onsubmit="return comprobarMateria()"  action="index.php?controlador=Materias" method="post">
        ...
        <div class="form-group form-group-md">
            <label class="col-md-4 col-lg-3 control-label" for="AdjuntoM">Adjunto</label>
            <div class="col-md-8 col-lg-9">
                <input id="AdjuntoM" name="AdjuntoM" type="file" class="form-control <?php if(isset($errores) && in_array("AdjuntoM", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["AdjuntoM"])?$_POST["AdjuntoM"]:''?>" >
            </div>
        </div>
