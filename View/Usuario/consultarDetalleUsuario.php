...
<div class="col-md-10 izquierda">
    <div class="form-group col-lg-6">
        ...
        <p align="center">
            <button type="button" class="btn btn-orange " onclick="window.location.href='../../Controller/UsuariosController.php?evento=borrarUsuario&LoginU=<?php echo $row['LoginU']; ?>'">Borrar Perfil</button>
        </p>
    </div>
