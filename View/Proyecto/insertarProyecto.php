            ...
            <div class="cotainer">
                ...
                <form id="formulario" class="form-horizontal" enctype="multipart/form-data" onsubmit="return comprobarProyecto()"  action="index.php?controlador=Proyectos" method="post">
                    ...
                    <div class="form-group form-group-md">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input id="AdjuntoProy" name="AdjuntoProy" type="file" class="form-control <?php if(isset($errores) && in_array("AdjuntoProy", $errores)){ echo " error"; } ?>" value="<?=isset($_POST["AdjuntoProy"])?$_POST["AdjuntoProy"]:''?>" >
                        </div>
                    </div>
