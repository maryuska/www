            ...
            <div class="cotainer">
                ...
                <div class="row">
                    <form class="form-horizontal" action="index.php?controlador=Proyectos" method="POST" role="search">
                        ...
                        <div class="col-lg-6 col-md-3 col-xs-2 text-right">
                            <a class="btn btn-orange " href="index.php?controlador=Proyectos&evento=paginaInsertarProyecto">
                                Insertar proyecto
                            </a>
                        </div>
                    </form>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                        <?php
                        $lista = $_SESSION["listarProyectos"];
                        $contador   = 1;
                        if (isset($lista)) {
                    ...
                    <div class="tab-pane fade in " id="tab2">
                        <?php
                        $lista1 = $_SESSION["listarProyectosInvestigador"];
                        $contador1   = 1;
                        if (isset($lista1)) {
                    ...
                    <div class="tab-pane fade in " id="tab3">
                        <?php
                        $lista2 = $_SESSION["listarProyectosInvestigadorPrincipal"];
                        $contador2   = 1;
                        if (isset($lista2)) {
